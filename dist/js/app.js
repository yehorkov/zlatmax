(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-block__slider")) new swiper_core_Swiper(".main-block__slider", {
        ...
        if (document.querySelector(".products-slider")) new swiper_core_Swiper(".products-slider__slider", {
        ...
        if (document.querySelector(".products-new")) new swiper_core_Swiper(".products-new__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".thumbs-images")) {
            const thumbsSwiper = new swiper_core_Swiper(".thumbs-images", {
